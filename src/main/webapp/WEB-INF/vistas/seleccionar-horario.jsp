               ...
               <div class="contact">
                  ...
                  <div class="col-md-8 col-md-offset-2">
                     <div class="contact-us">
                        <h2 stye="text-align:center">Seleccionar Horario</h2>					      	
							  ...
							  <c:forEach items="${horarios}" var="entry">
								<tbody>
							      <tr>
									...
									<td><a href='seleccionar-horario-partido?idHorario=<c:out value="${entry.id}" />'
										   class="btn btn-primary" role="button"> Seleccionar Horario</a></td>
								  </tr>
							  </tbody>
							  </c:forEach>
							</table>
